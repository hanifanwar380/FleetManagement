    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: white;">
            ...
            <p>A management system where you can easily manage vehicles and book transport</p>

            <?php if(isset($_SESSION['username'])==true) { ?>
            <a class="btn btn-success" style="text-align: center" href="booking.php">Book Transport</a>

            <?php } else{  ?>
            <a class="btn btn-success" style="text-align: center" href="login.php">Login To Book Transport</a>
            <?php } ?>
       ...
       <br><br>
        <div id="bus_route" class="container">
          <div class="page-header">
            <h1 style="text-align: center">Vehicle Route</h1>
          </div>
          <div class="row">
              <div class="col-md-6 foo">
                <p><b>Vehicles go in various routes.</b></p>
        ...
        <div id="driver" class="container">
          ...
          <div class="row">
              <div class="col-md-12">
                  <p style="font-size: 20px;">The driver of every routes are very punctual and they provides great service. Every one of them is professional and great at their jobs</p>
        ...
        <div id="bus" class="container">
          ...
          <div class="row">
              <div class="col-md-6">
                ...
                <img src="fleet.jpg" class="img-responsive" >
              </div>
              <div class="col-md-6 foo1">
                  <p style="font-size:20px;"><b>In every route there are very competent drivers.</b></p>
              </div>
          </div>
        </div>
        <div>
          <div class="page-header">
            ...
            <p style="font-size:20px; text-align: center"><b>Please consider leaving us a feed back to enhance user experiance.</b></p>
            <div id="feedback" class="feedback">
              <span><a href="http://localhost/feedback.html">Feed back</a></span>
            </div>
          </div>
          <br>
          <br>
