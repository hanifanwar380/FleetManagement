            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="vehicle">Vehicle</label> &nbsp;
                      <label><input type="radio" name="type" value="truck">Truck</label>
                    </div>
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon"><b>Date of Requirement</b></span>
                      <input id="req_date" type="text" class="form-control" name="req_date" placeholder="Day the vehicle is needed" required>
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><b>Date vehicle will return</b></span>
                      <input id="return_date" type="text" class="form-control" name="return_date" placeholder="Day vehicle will return" required>
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><b>Booking Requirements</b></span>
                      <input id="reason" type="text" class="form-control" name="reason" placeholder="What will the vehicle be used for">
                    </div>
                    <br>
